          ...
          <el-col :span="21">
            <div class="postInfo-container">
              <el-row>
                ...
                <el-col :span="4">
                  <el-form-item label-width="225px" label="提供服务时长:" class="postInfo-container-item">
    ...
    methods: {
      ...
      submit: function() {
        ...
        if (this.postForm.service_content === undefined) {
          ...
          axios.post('http://' + port.info.host + ':' + port.info.port + '/api/postNewApplication', params).then(
            (res) => {
              console.log(res)
            }
          ).catch((err) => {
